...
$("create_btn").onclick = function() {
	...
	var ajax_url = "/CreateFileServlet?path=" + path + "&" + "name=";
	var data = name;
	alert(data);
	ajax({
		    method : 'get',
...
$("save").onclick = function() {
	var ajax_url = "ModifyFileServlet";
	var now_path = $("path_span").innerHTML;
	var path = now_path + "\\";
	var name = $("file-cont-edit").title;
	var content = $("file-cont-edit").value;
	var data = "path=" + path + name + "&" + "content=" + content;
	ajax({
		    method : "post",
		    url : ajax_url,
		    data : data,
